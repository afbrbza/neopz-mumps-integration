...
int main(int argc, char const *argv[]) {
  ...
  // auto & here means that pardisoControl is a reference to the object returned by GetPardisoControl()
  ...
  pardisoControl.SetMessageLevel(1); // print statistical information
